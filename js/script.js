...
const config = {
    serverInfo: {
        ...
        serverName: "AxoSMP", /*Server name*/
        serverIp: "axosmp.online", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1145335115124314192" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
